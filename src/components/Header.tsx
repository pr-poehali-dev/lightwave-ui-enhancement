    ...
    >
      <nav className="container mx-auto px-6 flex items-center justify-between md:px-[24]">
        <a href="/" className="flex items-center gap-2 group" onClick={scrollToTop}>
          <span className="text-white font-semibold text-xl tracking-tight">☕ Вафля</span>
        </a>
        ...
        <ul className="hidden md:flex items-center gap-10 text-sm tracking-wide">
          {[
            ...
            <li key={item.label}>
              <a
                href={item.href}
                className="hover:text-orange-300 transition-colors duration-300 relative after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 hover:after:w-full after:bg-orange-300 after:transition-all after:duration-300 text-white"
              >
                {item.label}
              </a>
            </li>
        ...
        <a
          href="#contact"
          className="hidden md:inline-flex items-center gap-2 text-sm px-5 py-2.5 transition-all duration-300 bg-orange-400 text-white border border-orange-400 hover:bg-orange-500 hover:border-orange-500"
        >
          Заказать
        </a>
