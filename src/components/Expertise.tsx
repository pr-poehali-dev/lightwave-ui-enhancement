...
const services = [
  {
    ...
    description: "Уютный зал на 30 мест с детским уголком. Приходите всей семьёй — Пн–Пт с 08:00 до 20:30, Сб–Вс с 09:00 до 20:30.",
    icon: "UtensilsCrossed",
  },
  {
    title: "Доставка на дом",
    description:
      "Доставляем горячие вафли по всему Ярославлю за 45 минут. Пн–Пт с 08:00 до 20:30, Сб–Вс с 09:00 до 20:30.",
    icon: "Truck",
  },
  {
